...
#define BME280_ADDRESS 0xEC  // Indirizzo del sensore BME280 con SDO collegato a massa

extern float Temperature, Pressure, Humidity; // Variabili globali per memorizzare temperatura, pressione e umidità

uint8_t chipID; // Variabile per memorizzare l'ID del chip

uint8_t TrimParam[36]; // Array per memorizzare i parametri di calibrazione letti dalla ROM NVM del BME280
int32_t tRaw, pRaw, hRaw; // Variabili per memorizzare i valori grezzi di temperatura, pressione e umidità

// Variabili per memorizzare i parametri di calibrazione
...
#elif SUPPORT_32BIT
            // Compensa il valore grezzo della pressione utilizzando una funzione a 32 bit e lo converte in Pa
